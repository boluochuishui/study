...
public class SyncChainExecutor implements ChainExecutor<ChainContext> {
    ...
    public SyncChainExecutor(
            ChainExceptionHandler<ChainContext> exceptionHandler,
            ChainExecutionListener<ChainContext> executionListener
    ) {
    ...
    private ChainNodeResult invokeHandler(
